...
const ResetPassword = () => {
  ...
  const handleValidation = ( event ) => {
      ...
      if ( inputFieldName === 'newPassword' ) {
          ...
          if ( !uppercasePassword ) {
              ...
              setPasswordErrorMsg ( "Password must contain atleast one special character!" );
  ...
  const handleResetPassword = event => {
      ...
      if ( errorCount > 0 ) {
          ...
          CommonService.resetPassword ( newPassword, token )
            .then( ( response ) => {
                ...
                <div className="modal-header">
                  <div className="h5 modal-title">
                    ...
                    <h6 className="mt-1 mb-0 opacity-8">
                      <span>Enter the new and confirm password to reset it.</span>
                    </h6>
                  </div>
                </div>

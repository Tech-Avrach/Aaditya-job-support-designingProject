...
const AddAccountInformation = ({ userDetail }) => {
                  ...
                  <>
                    <Col md="4">
                      <FormGroup>
                        ...
                        <Input
                          invalid={legalBusinessNameErr !== "" ? true : false}
                          type="text"
                        ...
                        {legalBusinessNameErr !== "" && (
                          <FormFeedback>{legalBusinessNameErr}</FormFeedback>
                        )}
                      </FormGroup>
                    </Col>
                    ...
                    <Col md="4">
                      <FormGroup>
                        ...
                        <Input
                          ...
                          value={currentUser.dbaName ? currentUser.dbaName : ""}
                          onChange={handleInputChange}
                        />
                      </FormGroup>
                    </Col>
                ...
                <Col md="4">
                  <FormGroup>
                    ...
                    <Input
                      ...
                      id="address1"
                      placeholder="Address..."
                      value={currentUser.address1 ? currentUser.address1 : ""}
                      onChange={handleInputChange}
                      onKeyUp={handleValidation}
                    />
                  </FormGroup>
                ...
                <Col md="4">
                  <FormGroup>
                    ...
                    <Input
                      ...
                      id="address2"
                      placeholder="Address..."
                      value={currentUser.address2 ? currentUser.address2 : ""}
                      onChange={handleInputChange}
                    />
                  </FormGroup>
                </Col>
